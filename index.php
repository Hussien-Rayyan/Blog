<?php
    ...
    $featuerd_query = "SELECT * FROM posts WHERE is_featured=1" ;
    $featured_result =mysqli_query($con , $featuerd_query);
...
<?php if(mysqli_num_rows($featured_result) == 1) : ?>
    ...
    <section class="featured">
        <div class="container post featured-container">
            <div class="post-thumbnail">
                <img src="./images/<?= $featured['thumbnail'] ?>" alt="post thumbnail">
            </div>
            <div class="post-info">
                <?php
                ...
                ?>
                <a href="<?= ROOT_URL?>category-post.php?id=<?= $featured['category_id']?>" class="category-btn"><?= $category['title'] ?></a>
                <h2 class="post-title"><a href="<?= ROOT_URL?>posts.php?id=<?= $featured['id']?>"><?= $featured['title'] ?></a></h2>
    ...
    <!-- End Featured -->
    <!-- start posts -->
    <div class="posts <?= $featured ? '' : 'section-extra-margin' ?> ">
